...
for trait in traits:
    traitFiles = os.listdir(os.path.dirname(os.path.realpath(__file__)) + "\\traits\\"+ folder + "\\" + trait)
...
print(" {} < {} ".format(possibleOutput, imageCount))
...
while outputCount < imageCount:
    ...
    for trait in traits:
        ...
        layerFiles[trait] = Image.open(os.path.dirname(os.path.realpath(__file__)) + "\\traits\\"+ folder + "\\" + trait + "\\" + traitChoice)
